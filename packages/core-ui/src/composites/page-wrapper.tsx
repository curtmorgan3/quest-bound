...
export function PageWrapper({
  ...
  return (
    <div className={cn('page-wrapper flex h-full w-full flex-col overflow-hidden', className)}>
      <div
        className={cn(
      ...
      <div className={cn('flex min-h-0 flex-1 flex-col gap-4 overflow-auto p-2', contentClassName)}>
        {children}
      </div>
    </div>
  );
