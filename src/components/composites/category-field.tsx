...
export interface CategoryFieldProps {
  /** Current category value (nullable). */
  value: string | null;
  /** Called when the user selects, creates, or clears the category. */
  onChange: (value: string | null) => void;
  /** Sorted list of existing category names to show in the dropdown. Pass categories from the entity type you're editing (e.g. scripts, documents, items). */
...
/**
 * Type-ahead dropdown for entity category. Use for any entity that has a category
 * (scripts, documents, actions, attributes, charts, items, windows, pages).
 * Pass existingCategories from the parent (e.g. derived from useScripts(), useDocuments(), etc.).
 * When no match is found, shows an action to create a category from the current field value.
 */
