...
export const Documents = ({ onEditDetails, campaignId }: DocumentChartProps) => {
  const options = campaignId != null ? { campaignId } : undefined;
  ...
  const isRulesetContext = campaignId == null;
  ...
  const handleCategoryChange = (value: string) => {
    ...
    if (rulesetId)
      setListFilters(rulesetId, 'documents', { category: value === ALL_CATEGORIES ? null : value });
  };
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <MarkdownEditorPanel
        ...
        mode='edit'
        rulesetId={campaignId ? undefined : activeRuleset?.id}
