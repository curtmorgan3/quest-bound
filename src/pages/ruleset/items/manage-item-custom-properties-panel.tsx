...
import {
  useItemCustomProperties,
  useActiveRuleset,
} from '@/lib/compass-api';
import type { Item, CustomPropertyType } from '@/types';
      ...
      <Sheet>
        ...
        <SheetContent
          ...
          <SheetHeader className='shrink-0 border-b px-6 py-4'>
            ...
            <SheetDescription>
              Custom properties assigned to this item are used when the item is added to an inventory.
            </SheetDescription>
          </SheetHeader>
          <div className='flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-6'>
            ...
            {customProperties.length === 0 ? (
              <p className='text-sm text-muted-foreground py-4'>
                No custom properties assigned. Add one to define values when this item is added to an inventory.
              </p>
            ) : (
              <div className='flex min-h-0 flex-1 flex-col gap-2 overflow-auto'>
                ...
                filteredProperties.map((cp) => {
                  const icp = itemCustomProperties.find(
